...
# use that parameter together with android.service_class_name,
# see Android Services documentation for more details
...
#android.whitelist_file =

# (str) Path to a custom blacklist file
#android.blacklist_file =
...
#android.add_java_compile_args = -source 1.8

# (str) python-for-android branch to use, defaults to master
#p4a.branch = master

# (str) OUYA Console category. Should be one of GAME or APP
# If you leave this blank, OUYA will classify your app as a GAME
...
# (list) Android additional libraries to copy inside libs/armeabi
...
# (list) Android shared libraries written in python and which
# can be imported at runtime
#android.gradle_dependencies =

# Change python3 version for android
#android.python_version = cpython-3.11
